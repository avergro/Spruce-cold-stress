...
table(sign(res3$log2FoldChange[res3$padj <= .01 & !is.na(res3$padj) & abs(res3$log2FoldChange)>=1]))
plot(density(res3$log2FoldChange[res3$padj <= .01 & !is.na(res3$padj)& abs(res3$log2FoldChange)>=1]))
